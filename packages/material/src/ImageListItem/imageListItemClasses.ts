import { unstable_generateUtilityClasses as generateUtilityClasses } from "@suid/utils";
...
const imageListItemClasses: ImageListItemClasses = generateUtilityClasses(
  "MuiImageListItem",
